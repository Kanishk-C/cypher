...
class UIFormatter:
    ...
    def format_box(title: str, content: dict, width: int = None) -> str:
        ...
        lines.append(
            f"│ {colors.Colors.BRIGHT_GREEN}{title}{colors.Colors.BRIGHT_CYAN}{' ' * title_padding}│"
        )
        ...
        for key, value in content.items():
            ...
            lines.append(
                f"│ {colors.Colors.BRIGHT_BLUE}{display}{colors.Colors.BRIGHT_CYAN}{' ' * padding}│"
            )
    ...
    def format_table(headers: list, rows: list) -> str:
        ...
        lines.append(
            f"{colors.Colors.BRIGHT_BLACK}{'─' * len(header_line)}{colors.Colors.RESET}"
        )
